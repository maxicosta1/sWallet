    ...
    <form action={action} className="grid gap-4">
      <Label>
        ...
        <div className="relative">
          ...
          <Input className="pl-10" name="email" type="email" defaultValue="admin@scode.com" required />
        </div>
      </Label>
      <Label>
        Contraseña
        <div className="relative">
          ...
          <Input className="pl-10" name="password" type="password" defaultValue="admin123456" required minLength={8} />
        </div>
      </Label>
